    ...
    <div id="skills">
      <div className="mx-auto sm:w-[90%] md:w-[80%] px-2 pt-4 sm:p-6 md:p-10 mt-2 text-[#303030] ">
        ...
        <div className=" mt-4 px-1 sm:hidden flex flex-wrap items-center justify-center gap-8">
          <img
            className="w-10 h-[50px] cursor-pointer hover:border-b-2 border-[#E1451D]"
            src="./HTML5.png"
            alt="HTML5"
            title="HTML5"
          />
          <img
            className="w-8 h-[50px] cursor-pointer hover:border-b-2 border-[#E1451D]"
            src="./CSS3.png"
            alt="CSS3"
            title="CSS3"
          />
          ...
          />
          <img
            className="w-14 h-[50px] cursor-pointer hover:border-b-2 border-[#E1451D]"
            src="./MySql.png"
            alt="MySQL"
            title="MySQL Database"
          />
          <img
            className="w-[100px] h-[50px] cursor-pointer hover:border-b-2 border-[#E1451D]"
            src="./Redux.png"
            alt="Redux"
            title="Redux - State Management"
          />
          <img
            className="w-[200px] h-[50px] cursor-pointer hover:border-b-2 border-[#E1451D]"
            src="./TailwindCSS.png"
            alt="TailwindCSS"
            title="Tailwind CSS"
          />
          <img
            className="w-12 h-[50px] cursor-pointer hover:border-b-2 border-[#E1451D]"
            src="./Bootstrap.png"
            alt="Bootstrap"
            title="Bootstrap Framework"
          />
          <img
            className="w-[120px] h-[50px] cursor-pointer hover:border-b-2 border-[#E1451D]"
            src="./Firebase.png"
            alt="Firebase"
            title="Firebase - Backend as a Service"
          />
          ...
          />
          <img
            className="w-[75px] h-[50px] cursor-pointer hover:border-b-2 border-[#E1451D]"
            src="./Git.png"
            alt="Git"
            title="Git - Version Control System"
          />
